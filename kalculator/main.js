let base = new function () {
  ...
  $.ajax({url: '../dashbord/get_price.php', method: 'GET', dataType: 'json', async: false, success: function(response){
    prRBD = response;

  }})
  $.ajax({url: '../dashbord/getTitelPrice.php', method: 'GET', dataType: 'json', async: false, success: function(response){
    titelBD = response;
  }})
