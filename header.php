...
<html lang="ru">
    ...
    <head>
        ...
        <meta
        name="ICBM" content="55.7558260, 37.6173000">
    ...
    <body style='overflow-x:hidden;'>
        <div class="page-wrapper">
            <div class="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse  " id="navbarNav">
                            <ul class="navbar-nav navbar-center me-auto mt-lg-0 mt-2   ">
                                <li class="nav-item ">
                                    <a class="nav-link" href="/#service"><img src="img/servs.png" height="35px" width="35px">
                                        УСЛУГИ</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="price.php"><img src="img/price.png" height="35px" width="35px">
                                        ЦЕНЫ</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="delivery.php"><img src="img/cont.png" height="35px" width="35px">
                                        ДОСТАВКА</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="online-pay.php"><img src="img/pay.png" height="35px" width="35px">
                                        ОПЛАТА</a>
                                </li>
                                <!--li class="nav-item ">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="dropdown" id="">
                                            <a class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false" id="bug2" style="margin: 5px 5px 5px 5px; ">
                                                Заказать
                                            </a>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li>
                                                    <a class="dropdown-item" href="zakaz_vizitki.php">Визитки</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="zakaz_listovkii.php">Листовки</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="zakaz_petchat.php">Печати</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="zakaz_petfoto.php">Печать фотографий</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="mugs.php">Печать на кружках</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <a href="#" class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto bug1" id="bug1" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin: 5px 5px 5px 5px; ">Контакты</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div id="b_1" class="carousel-item active" data-bs-interval="7000">
                                <a href="pechat_proektov.php"><img src="header_foto/Для Пк 1_3.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                            <div id="b_2" class="carousel-item" data-bs-interval="7000">
                                <a href="service_8.php"><img src="header_foto/Для Пк 2_1.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                            <div id="b_3" class="carousel-item" data-bs-interval="7000">
                                <a href="service_11.php"><img src="header_foto/Для ПК 3_2.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                ...
                <div id="del2" class="mobserv2">
                    <div id="carouselExampleInterval2" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="7000">
                                <a href="pechat_proektov.php"><img src="header_foto/Для моб 1_2.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                            <div class="carousel-item" data-bs-interval="7000">
                                <a href="service_8.php"><img src="header_foto/Для моб 2_3.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                            <div class="carousel-item" data-bs-interval="7000">
                                <a href="service_11.php"><img src="header_foto/Для моб 3_2.jpg" class="d-block w-100" alt="..."></a>
                            </div>
                            <div class="carousel-item" data-bs-interval="7000">
                ...
                <button class="pulse-button" data-bs-toggle="modal" data-bs-target="#exampleModal4">
