...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/88190204" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse  " id="navbarNav">
                <ul class="navbar-nav navbar-center me-auto mt-lg-0 mt-2   " >
                    <li class="nav-item ">
                        <a class="nav-link" href="/#service"><img src="img/servs.png" height="35px" width="35px"> УСЛУГИ</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="price.php"><img src="img/price.png" height="35px" width="35px"> ЦЕНЫ</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="delivery.php"><img src="img/cont.png" height="35px" width="35px"> ДОСТАВКА</a>
                    </li>
                    <li class="nav-item ">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dropdown"  id="">
                              <a class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto dropdown-toggle" href="#"  data-bs-toggle="dropdown" aria-expanded="false" id="bug2"  style="margin: 5px 5px 5px 5px; "> Заказать </a>
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="zakaz_vizitki.php">Визитки</a></li>
         ...
         <div class="row justify-content-center text-center">
             ...
             <div class="col-lg-6 mt-4 pt-2">
                <div>
                    ...
                    <h6>Если будет требоваться наша помощь c распечаткой ночью - пишите на нашу почту</h6>
                    <h6>info@copymaster.biz</h6>
