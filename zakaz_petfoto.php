...
<section class="section">
    <div class="container text-center">
        ...
        <hr>
        <h2 data-shadow='dang!'>Ответьте на 4 вопроса и получите скидку -10%
        </h2>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <button type="button" id="sendz" class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto" name="button" style="font-size:35px">Заказать
                </button>
            </div>
            <h3>
...
</div></div><!-- end modal --><!-- Modal --><div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
