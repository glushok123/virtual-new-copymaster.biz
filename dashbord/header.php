        ...
        <nav class="topbar-nav">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="./rasListOnGrafik.php"><i class="bx bx-right-arrow-alt"></i>Учет рабочего времени (автомат)</a>
                        </li>
                        <li>
                            <a href="./rasListOnGrafik.php"><i class="bx bx-right-arrow-alt"></i>График рабочего времени (автомат)</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="./openAndCloseSmena.php"><i class="bx bx-right-arrow-alt"></i>Открытие и закрытие
                                смены</a>
                        </li>
                    </ul>
                </li>
