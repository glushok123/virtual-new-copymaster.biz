...
// var_dump($_POST['idloadcheck']);
require_once './connect.php';
$stmt = $dbh->prepare("SELECT of.name, of.cost, of.item, of.price, of.count, of.offer_item, of.name_komp, of.tel, of.srok from offers as of where of.item = ?;");
...
$text .= "<table id=\"tablecheck\" ><tr class=\"chekItog\"><td colspan=\"9\" >Чек номер: ".$idloadcheck."</td></tr><tr><td>№</td><td>Услуга</td><td>Кол-во</td><td>Ед.</td><td>Цена</td><td>Стоимость</td><td>Заказчик</td><td>Контакты</td><td>Срок</td></tr>";
