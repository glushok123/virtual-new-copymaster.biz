...
<style>
	...
	<div class="switcher-wrapper">
		...
		<div class="switcher-body">
			<h5 class="mb-0 text-center text-uppercase">Действия</h5>
			<br>
			<hr>
			<div class='butn' data-toggle="modal" data-target="#exampleModal" style="background-color:red; color: white">Закрыть предыдущую и открыть новую смену</div>
