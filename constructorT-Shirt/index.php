        ...
        <section id="typography">
            <div class="page-header">
                <div class="row text-center">
                    <h1 class="text-center" style="text-align: center;">Конструктор Футболок</h1>
                </div>
            </div>
                            ...
                            <div class="tab-pane " id="tab1">
                                <div class="well">
                                    <select id="tshirttype">
                                        <option value="img/crew_front.png" selected="selected">Short Sleeve Shirts
                                        </option>
                                ...
                                <div class="well">
                                    <div class="input-append">
                                        ...
                                        <button id="add-text" class="btn" title="Add text"><i
                                                class="icon-share-alt"></i> Добавить</button>
                                    </div>
                                    <hr>
                                    <div>
                                        <input type="file" accept="image/*" multiple> <a href="#"
                                            class="upload_files btn btn-primary">Добавить свою картинку</a> <img
                                            id="blah" src="#" alt="your image" class="img-polaroid2"
                                            style="display:none" />
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="sizeShit"
                                                            value='S'>
                                        ...
                                        <div class=" ">
                                            ...
                                            <div class="control-group" id='status-form'>
                                                ...
                                                <input id="phone" type="text" class="form-control text-center "
                                                    style="max-width:500px;" placeholder="(999) 999-99-99"
                                                    required /><br>
                                            ...
                                            <label for="comment" class="form-label" style='margin-top:10px'>Комментарий
                                                к заказу:</label>
                        ...
                        <div class="clearfix">
                            <div class="btn-group inline pull-left" id="texteditor" style="display:none">
                                <button id="font-family" class="btn dropdown-toggle" data-toggle="dropdown"
                                    title="Шрифт"><i class="icon-font" style="width:19px;height:19px;"></i></button>
                                ...
                                <a class="btn" href="#" rel="tooltip" data-placement="top"
                                    data-original-title="Цвет текста">
                                    <input type="hidden" id="text-fontcolor" class="color-picker" size="7"
                                        value="#000000">
                                </a>
                                <a class="btn" href="#" rel="tooltip" data-placement="top"
                                    data-original-title="Цвет рамки">
                                    <input type="hidden" id="text-strokecolor" class="color-picker" size="7"
                                        value="#000000">
                                </a>
                            ...
                            <div class="pull-right" align="" id="imageeditor" style="display:none">
                                <div class="btn-group">
                                    <button class="btn" id="bring-to-front" title="Спереди"><i
