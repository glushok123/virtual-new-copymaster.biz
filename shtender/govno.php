<head>
  ...
  <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://mc.yandex.ru/metrika/tag.js"></script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
  ...
  <script>
	...
	<meta name="Keywords" content="копимастер, копимастер на октябрьской, копировальные центры, копировальный центр, копировальный центр круглосуточно">
	<title>Копировальный центр Копимастер на Октябрьской</title>
	<meta name="Description" content="Круглосуточный копировальный центр Копимастер на Октябрьской предлагает печать, сканирование, ксерокопию, брошюрование, ламинирование документов. ">
	...
	<style>
		body {top:0;margin:10px 0 0 0;font:normal 1em Verdana;}

		#ba404,#ba1,#ba2,#ba3,#ba4,#ba5,#ba6,#ba7,#ba8,#scrollup,.imp {
    ...
    margin-top: 100px;
		...
		h1 {
			font-size:1em; font-style:italic;font-weight:400;text-align:center;
			display:block; position:relative; float:left; width:100%; line-height:1em;
			padding:0.5em 0px; margin:0; border-bottom:solid 1px #ccc;
		}
		h2 {
			font-size:1em; font-weight:400;text-align:center; margin:0px;
			line-height:1em; padding:0.5em 0px; clear:both;
		}
		h2 {border-top:dashed 1px #99c;border-bottom:dashed 1px #99c;background:#eef;}
		h3{ font-size:1em; margin:0px; }
		h4{ font-size:1em; margin:0px; font-weight:700;}
		h5 {
			font:normal 15px/20px Calibri; text-decoration:underline;
		...
		/*a.a1:hover { text-decoration:none; color:#00cc99;}*/

		.w1 {
			position:relative;float:left;width:1000px;margin:0 calc(50% - 500px);
		}
		.w2 {
		...
		#logo {
			...
			width:220px; margin-left:20px; height:75px; font-style:italic;
			font-size:0.56em; line-height:135px; text-decoration:none; color:#666;
			overflow:hidden;
		}
    #anounce {
      color: red;
      ...
      margin:1.5em 0 0.5em 0;
		...
		#hmenu {
			position:absolute;line-height:17px; width:76%;left: 24%;
		}
		#hmenu>ul>li>a {
			padding: 20px 0px 20px 35px; text-decoration:none; color:#666;
		...
		#hmenu>ul>li:nth-of-type(1)>a {background:url('img/servs.png') no-repeat left; background-size: 25px;}
		#hmenu>ul>li:nth-of-type(2)>a {background:url('img/price.png') no-repeat left; background-size: 25px;}
		#hmenu>ul>li:nth-of-type(3)>a {background:url('img/cont.png') no-repeat left; background-size: 25px;}
		/*#hmenu>ul>li:nth-of-type(4)>a {background:url('img/vakan.png') no-repeat left; background-size: 25px;}/*/
		#hmenu>ul>li:nth-of-type(4)>a {background:url('img/inf.png') no-repeat left; background-size: 25px;}
		#hmenu>ul>li:nth-of-type(5)>a {background:url('img/pay.png') no-repeat left; background-size: 25px;}
		#hmenu>ul>li:hover {text-de acoration:underline;}
		#hmenu>ul>span:nth-child(1) {
			height:100%; padding:54px 1px 54px 0px; margin:0 15px; background:#ddd;
		}
		#hmenu span {
			height:100%; padding:54px 1px 54px 0px; margin:0 5px;
		}
...
/*		#banner {
			position:relative; float:left; overflow:hidden; background:#666; margin-top:10px;
		}*/
		#banner img {position:relative; width:100%; height:auto;}
		#ba1 { background: url("img/bann1.jpg");}
		#ba2 { background: url("img/bann2.jpg");}
		#ba3 { background: url("img/bann3.jpg");}
		#ba4 { background: url("img/bann4.jpg");}
		#ba5 { background: url("img/bann5.jpg");}
		#ba6 { background: url("img/bann6.jpg");}
		#ba404 { background: url("img/b404-bg.jpg");}

		#ba404,#ba1,#ba2,#ba3,#ba4,#ba5,#ba6 {
			position:absolute;background-size:100% 100%;top:0;left:0
		}
		.bhide {
			opacity:0; width:calc(100% + 100px); height:calc(100% + 100px);
			margin:-50px 0 0 -50px;
		}
		.bshow {opacity:1; width:100%; height:100%; margin:0;}
		...
		#promo div {
			position:relative;float:left; display:block; width:16.66%; height:140px;
			padding-top:100px; box-sizing: border-box; border-left:solid 1px #ddd;
			border-bottom:solid 1px #ddd; text-align:center; text-transform:uppercase;
			color:#666;
		}
		#promo a:nth-of-type(1) div {background:url("img/promo-1.png") no-repeat 50% 10px;}
		#promo a:nth-of-type(2) div {background:url("img/promo-2.png") no-repeat 50% 10px;}
		#promo a:nth-of-type(3) div {background:url("img/promo-3.png") no-repeat 50% 10px;}
		#promo a:nth-of-type(4) div {background:url("img/promo-4.png") no-repeat 50% 10px;}
		#promo a:nth-of-type(5) div {background:url("img/promo-5.png") no-repeat 50% 10px;}
		#promo a:nth-of-type(6) div {background:url("img/promo-6.png") no-repeat 50% 10px;}


		.con {text-align:justify;}
		.con p {
			padding:1em 0.5em 0 0.5em;margin:0; font-size:0.8em; line-height:1.5em;
		}
		.con ul,.con ol, .tab ol {
			padding:0.5em 0.5em 0.5em 3em ;font-size:0.75em;margin:0;overflow:hidden;
		}
		.con img {
			width:calc(33% - 1em); position:relative; margin:0.5em;
			display:block; float:left;
		}
        .con img.i50 { width:calc(50% - 1em); }
        .con img.i100 { width:calc(100% - 1em); }
		#mapimg {
			position:fixed;width:640px;height:480px;top:80px;left:50%;margin-left:-320px;
			border:solid 2px #333;border-radius:10px;z-index:2;overflow:hidden;
			background:url('img/map.png')no-repeat center;
		}
		#mapshade {
			position:fixed;width:100%;height:100%;top:0;left:0;z-index:1;overflow:hidden;
			background: #000;opacity: 0.5; cursor:pointer;
		}
		#mapclose {
			position:absolute;top:-40px;right:-40px;width:80px;height:80px;
			border-radius:40px; border:solid 1px #000; background:#f33;color:#fff;
			text-indent:15px; line-height:110px;font-weight:700;cursor:pointer;
			font-size:1.5em; box-shadow:inset 0 0 10px 0 #000;text-shadow:0 0 5px #000;
		}

		#scrollup {
			position:fixed;left:1em; padding:1em 1em 2em 1em; line-height:1em;
			text-transform: uppercase; color:#fff; background:#333; cursor:pointer;
		}
			.scrup1 {bottom:-4em; opacity:0;}
			.scrup2 {bottom:0;opacity:0.75;}
			.scrup2:hover {opacity:1;}

		.foot {text-align:center;font-size:0.8em;}
		.foot a {margin:0.5em; line-height:2em;}
		.foot div { clear:both;}


		#services {
			text-align:center; width:100%; display:block; margin:1.5em 0;
			float:left;font-size:1.25em; text-transform:uppercase;
		}
		.services {display:flex; flex-wrap:wrap; justify-content:center;}
		.servlist {
			flex:1 1 240px; max-width:400px;margin:1em; box-shadow:0 0 2px 0px #ccc;
		...
		.servlist:hover {color:#f33;box-shadow:0 0 5px 0px #f33;}
		.servlist:nth-child(1) {background:url("img/servlist_1.jpg")no-repeat top;}
		.servlist:nth-child(2) {background:url("img/servlist_2.jpg")no-repeat top;}
		.servlist:nth-child(3) {background:url("img/servlist_3.jpg")no-repeat top;}
		.servlist:nth-child(4) {background:url("img/servlist_4.jpg")no-repeat top;}
		.servlist:nth-child(5) {background:url("img/p123.jpg")no-repeat top;}
		.servlist:nth-child(6) {background:url("img/bookscan1.jpg")no-repeat top;}
		.servlist:nth-child(7) {background:url("img/servlist_7.jpg")no-repeat top;}
		.servlist:nth-child(8) {background:url("img/servlist_8.jpg")no-repeat top;}
		.servlist:nth-child(9) {background:url("img/servlist_9.jpg")no-repeat top;}
		.servlist:nth-child(10) {background:url("img/servlist_10.jpg")no-repeat top;}
		.servlist:nth-child(11) {background:url("img/servlist_11.jpg")no-repeat top;}
		.servlist:nth-child(12) {background:url("img/servlist_12.jpg")no-repeat top;}
		.servlist:nth-child(13) {background:url("img/servlist_13.jpg")no-repeat top;}
		.servlist:nth-child(14) {background:url("img/servlist_14.jpg")no-repeat top;}

		#contawrap {
			position:relative;float:right;
			width:calc(50% - 2em);margin:1em;font-size:1.125em;
		}
		#contawrap form {
			font-size: 1em; text-align: left !important;
		}
		#mapwrap {
			position:relative;float:left;width:calc(50% - 2em); margin:1em;
			height:360px; background:url("img/map.png")no-repeat center;
		}
		@media screen and (max-width:860px) {
			#mapwrap {height:360px;}
			#contawrap {width:100%; margin:1em 0;}
			#contawrap form {text-align:center !important;}
		}

		.priceSwitch {
			position:relative; float:left; width:45%; margin:5px 2.5%;
			height:50px; line-height:50px; background:#9f9; text-align:center;
			cursor:pointer; font-size:0.8em;
		}
		.priceSwitch:hover {background:#6f6;}
		#priceFiz, #priceUrl, .priceSwitch {
			-moz-transition:all 0.5s ease;
			transition:all 0.5s ease;
		}
		#priceFiz div, #priceUrl div {
			text-align:center; font-size:125%; height:50px; line-height:50px;
		}
		.priceShow {
		...
		table {
			background: #666; width:calc(100% - 1em); text-align:center;
			margin:0.5em; border-spacing:1px;
			font:normal 1em Tahoma;table-layout:fixed;
		}
		td { background:#fff; padding:2px 0px; }
		.tr1 td { background: #fde9d9; font-size:1.125em; line-height:1.5em; font-weight: 700;}
		.tr2 td { background: #9cf; font-size:1.125em; }

		@media screen and (max-width:575px) {
			#hmenu span:nth-of-type(5),#hmenu span:nth-of-type(1) {display:none;}
			table {font-size:0.64em;}
		}


		@media screen and (max-width:1520px) {
			#conta {width:360px; margin-right:0; font-size:1em;}
			.w2 {width:100%;margin:0;}
			#logo {margin-left:10px;}
			#hmenu a {font-size:0.8em;background-size:45px !important;padding-left:50px;}
			#hmenu span {margin:0 calc(10% - 119px) 0 calc(10% - 125px);}
		}
		@media screen and (max-width:1200px) {
			#conta {margin-right:40px;}
			#logo {margin-left:20px;}
			#hmenu {position:relative;float:left; width:100%;height:81px; line-height:81px; }
			#hmenu span {margin:0 3%;}
			#promo div {font-size:0.8em}
		}
		@media screen and (max-width:1020px) {
			#promo div {background-size:auto 50px !important; padding-top: 75px; height:125px;
			}
...
.clock24{display: none;}
		}
		@media screen and (max-width:860px) {
			#conta {margin-right:0;}
			#mapwrap {height:360px;}
			/*#logo {//margin-left:0;}*/
			#mapwrap {width:100%; margin:1em 0;}
		}
		@media screen and (max-width:700px) {

			#conta {width:100%;line-height:27px; height:81px}
			#promo div {width:33.33%;}
			#hmenu {height:54px; line-height:54px;}
			#hmenu a {font-size:0.64em;background-size:30px !important;padding-left:32px;}
			#promo div {font-size:0.64em}
			#logo { height:67px; width:210px;}
			#mapimg {width:95%;left:2.5%;margin-left:0;}
		}
		@media screen and (max-width:575px) {
			#hmenu span:nth-of-type(5),#hmenu span:nth-of-type(1) {display:none;}
		}
		@media screen and (max-width:450px) {
			#hmenu span {margin:0 4px 0 1px;}
			#hmenu a {font-size:0.64em;background-position:top !important;padding:30px 0px 0px 0px;}
			#scrollup {display:none;}
			#mapimg {height:360px; top:40px;}
